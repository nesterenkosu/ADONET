...
namespace ConsoleDataSet {
    ...
    public partial class MyDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string Username, int Age) {
...
namespace ConsoleDataSet.MyDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Users] WHERE (([Id] = @Original_Id) AND ((@IsNull_Username = 1 AND [" +
                "Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Age = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Users] ([Username], [Age]) VALUES (@Username, @Age);\r\nSELECT Id, Use" +
                "rname, Age FROM Users WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Users] SET [Username] = @Username, [Age] = @Age WHERE (([Id] = @Original_Id) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT Id, Username, Age FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ConsoleDataSet.Properties.Settings.Default.MyDBConnectionString;
        }
        ...
        public virtual int Update(string Username, global::System.Nullable<int> Age, int Original_Id, string Original_Username, global::System.Nullable<int> Original_Age, int Id) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, global::System.Nullable<int> Age, int Original_Id, string Original_Username, global::System.Nullable<int> Original_Age) {
            return this.Update(Username, Age, Original_Id, Original_Username, Original_Age, Original_Id);
        }
    }
